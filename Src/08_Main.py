...
##print(f"the root mean squared for Linear Regression{lin_rmse}")
line_rmses = -cross_val_score(lin_reg,housing_prepared,housing_labels,scoring="neg_root_mean_squared_error",cv=10)

print(pd.Series(line_rmses).describe())
...
#print(f"the root mean squared for Desicion Tree Regressor{dec_rmses}")

print(pd.Series(dec_rmses).describe())

# Random Forest Model                   using this for Better fitting
...
#print(f"the root mean squared for Random Forest Regressor :{random_forest_rmse}")
